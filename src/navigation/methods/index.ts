...
import {AdminStackParamList} from '../admin';
import {AdminBottomTabStackParamList} from '../adminBottomTab';
import {ArtistBottomTabStackParamList} from '../artistBottomTab';
import {ArtistDrawerStackParamList} from '../artistDrawer';
import {ArtistStackParamList} from '../artists';

export type StackParamList = ArtistBottomTabStackParamList &
  ArtistDrawerStackParamList &
  ArtistStackParamList &
  AdminBottomTabStackParamList &
  AdminStackParamList;
