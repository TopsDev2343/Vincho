...
import PreLogin from '../Profile/PreLogin';
import LoginSetting from '../Profile/LoginSetting';
  ...
  function renderView() {
    switch (targetScreen) {
      ...
      case 'InitSetupScreen':
        return (
          <LoginSetting navToScreen="InitSetupScreen" navigation={navigation} />
        );
      case 'LocationScreen':
        return (
          <LoginSetting navToScreen="LocationScreen" navigation={navigation} />
        );
      case 'ContactScreen':
        return (
          <LoginSetting navToScreen="ContactScreen" navigation={navigation} />
        );
      case 'FollowContact':
        return (
          <LoginSetting navToScreen="FollowContact" navigation={navigation} />
        );
