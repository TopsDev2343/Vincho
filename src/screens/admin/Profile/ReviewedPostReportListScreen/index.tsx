...
import {useGetReviewedReportPosts} from '~/hooks/admin/Reports';
import {getKeyByValue} from '~/utils/getKeyByValue';

function ReviewedPostReportListScreen({route}: {route: any}) {
...
export default ReviewedPostReportListScreen;
