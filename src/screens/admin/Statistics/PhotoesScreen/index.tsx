...
import {useGetPostsByCategoryAndFileType} from '~/hooks/artist/Categories';
import {
  getLastMonthDate,
  getLastWeekDate,
  getTodayDate,
...
const PhotoesScreen = ({route}: {route: any}) => {
  const totalPhotoes = route.params?.totalPhotoes;
            ...
            <View mt={10}>
              <View px={5} justifyContent={'center'} alignItems={'center'}>
                <HStack
                  ...
                  ml={2.5}>
                  <HelveticaRegularText
                    text="Share of each photo's category"
                    fontSize={14}
                    color={Colors.white}
                  />
                  <View>
